<x-app-layout>
    <x-slot name="breadcrumbs">
        ...
        <span class="text-slate-600">Encaminhamentos</span>
    </x-slot>
                        ...
                        <tbody>
                            @forelse ($encaminhamentos as $item)
                                <tr class="table-row">
                                    ...
                                    <td class="table-cell">
                                        <div class="text-slate-800 font-medium">{{ $item->instituicao_destino }}</div>
                                        <div class="text-xs text-slate-400">{{ $item->especialidade }}</div>
                                    </td>
                                    <td class="table-cell">
                                    ...
                                    <td class="table-cell text-xs text-slate-500 uppercase">
